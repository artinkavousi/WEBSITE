...
- [Introduction](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#introduction)
	- [Why TSL?](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#why-tsl)
	- [Example](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#example)
	- [Architecture](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#architecture)
- [Learning TSL](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#learning-tsl)
- [Constants and explicit conversions](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#constants-and-explicit-conversions)
- [Conversions](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#conversions)
- [Uniform](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#uniform)
	- [onUpdate](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#uniformonupdate)
- [Swizzle](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#swizzle)
- [Operators](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#operators)
- [Function](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#function)
- [Variables](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#variables)
- [Array](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#array)
	- [Uniform](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#array-uniform)
- [Varying](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#varying)
- [Conditional](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#conditional)
	- [If-else](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#if-else)
	- [Switch-case](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#switch-case)
	- [Ternary](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#ternary)
- [Loop](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#loop)
- [Math](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#math)
- [Method chaining](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#method-chaining)
- [Texture](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#texture)
- [Attributes](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#attributes)
- [Position](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#position)
- [Normal](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#normal)
- [Tangent](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#tangent)
- [Bitangent](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#bitangent)
- [Camera](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#bitangent)
- [Model](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#bitangent)
- [Screen](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#screen)
- [Viewport](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#viewport)
- [Blend Modes](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#blend-modes)
- [Reflect](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#reflect)
- [UV Utils](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#uv-utils)
- [Interpolation](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#interpolation)
- [Random](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#random)
- [Rotate](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#rotate)
- [Oscillator](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#oscillator)
- [Packing](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#packing)
- [NodeMaterial](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#nodematerial)
	- [LineDashedNodeMaterial](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#linedashednodematerial)
	- [MeshPhongNodeMaterial](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#meshphongnodematerial)
	- [MeshStandardNodeMaterial](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#meshstandardnodematerial)
		- [MeshPhysicalNodeMaterial](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#meshphysicalnodematerial)
	- [SpriteNodeMaterial](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#spritenodematerial)
- [Transitioning common GLSL properties to TSL](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#transitioning-common-glsl-properties-to-tsl)
...
- Focus on Intent
	- Build materials by connecting nodes through: [positionWorld](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#position), [normalWorld](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#normal), [screenUV](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#screen), [attribute()](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#attributes), etc. More declarative("what") vs. imperative("how").
- Composition & High-Level Concepts
	- Work with high-level concepts for Node Material like [colorNode](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#basic), [roughnessNode](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#standard), [metalnessNode](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#standard), [positionNode](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#basic), etc. This preserves the integrity of the lighting model while allowing customizations, helping to avoid mistakes from incorrect setups.
...
- Advanced users
	- Makes creating shaders simple but not limited. Example: [https://www.youtube.com/watch?v=C2gDL9Qk\_vo](https://www.youtube.com/watch?v=C2gDL9Qk_vo)
...
[See an example](https://github.com/mrdoob/three.js/wiki/?utm_source=chatgpt.com#deferred-function-high-level-of-customization-goodby-defines)
